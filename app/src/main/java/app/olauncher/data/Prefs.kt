...
class Prefs(private val context: Context) {
    ...
    private val USE_COLORFUL_ICONS = "USE_COLORFUL_ICONS"
    ...
    var useColorfulIcons: Boolean
        get() = prefs.getBoolean(USE_COLORFUL_ICONS, false)
        set(value) = prefs.edit { putBoolean(USE_COLORFUL_ICONS, value).apply() }
